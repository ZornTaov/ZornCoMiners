...
//            {
//
//                ZornCoMiners.LOGGER.info((context.getLevel().isClientSide()?"CLIENT ":"SERVER ") + node.getGraph().getNodeGraph().toString());
//            }
...
//            }
            ...
            {
                ZornCoMiners.LOGGER.info((context.getLevel().isClientSide()?"CLIENT: ":"SERVER: ") + nbt);
            }
        }
    ...
    private String wrapComment(String comment, @SuppressWarnings("SameParameterValue") int length) {
